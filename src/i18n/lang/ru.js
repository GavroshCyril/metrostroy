export const ruLang = {
  ...
  home: {
    ...
    moscowSubtitle:
      "Московская линия (1-я линия) - первая линия Минского метрополитена, открыта 30 июня 1984г. Линия длиной 19,2 км включает 15 станций. Московская линия целиком проходит под главной магистралью города",
  ...
  admin: {
    ...
    logIn: "Войти",
    info:
      " Перед началом администрирования веб-приложением, ознакомьтесь с руководством администратора, кликнув на",
  ...
  resources: {
    info:
      "Если вам необходима документация веб-приложения, Вы можете скачать ее при нажатии на",
