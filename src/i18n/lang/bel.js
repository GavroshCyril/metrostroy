export const belLang = {
  ...
  resources: {
    info:
      "Калі вам неабходна дакументацыя вэб-прыкладанні, Вы можаце спампаваць яе пры націску на",
  ...
  admin: {
    ...
    logIn: "Увайсці ў асабісты кабінет",
    info:
      " Перад пачаткам адміністравання вэб-дадаткам, азнаёмцеся з кіраўніцтвам адміністратара, клікнуўшы на",
