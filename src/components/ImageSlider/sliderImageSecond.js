...
export default [
  {
    ...
    description: "пересекает Минск с юго-востока на запад",
    urls: Second,
  },
  {
    title: "Автозаводская линия",
    description:
      "вторая линия Минского метрополитена, открыта 31 декабря 1990 года",
    urls: Third,
  },
  {
    title: "Автозаводская линия",
    description: "длиной 18,1 км включает четырнадцать станций",
    urls: First,
  },
];
